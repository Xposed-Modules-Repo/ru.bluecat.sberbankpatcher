...
- Разблокирован сервис Вжух
- Сортировка нижней панели навигации
- Платежи. Номер по умолчанию для переводов
- Профиль. Реклама в разделе недвижимость
- Карты. СберСпасибо
- История. Очистка истории транзакций от сервисный уведомлений
...
- Скрыто напоминание выдать доступ к контактам в разделе переводов на главной
